...
h=1; betas=pi/3; betad=pi/3; betar2=pi/3; betar1=3*pi/3;
...
subplot(224), Rb=4*h; polar(th,Rb+s), title('R_b=4h'),
...
% Plota SVAJ
figure(3), set(1,'position',[680 565 644 420]),
subplot(411), plot(t,s, 'r'), ylabel('S (cm)'), axis tight,
subplot(412), plot(t,v, 'r'), ylabel('V (cm/s)'), axis tight,
subplot(413), plot(t,a, 'r'), ylabel('A (cm/s^2)'), axis tight,
subplot(414), plot(t,j, 'r'), ylabel('J (cm/s^3)'), axis tight,
xlabel('Tempo (s)')

% Desenho came
figure(4), set(2,'position',[1325 565 560 420])
subplot(221), Rb=h/2; polar(th,Rb+s, 'r'), title('R_b=h/2'),
subplot(222), Rb=h/1; polar(th,Rb+s, 'r'), title('R_b=h'),
subplot(223), Rb=2*h; polar(th,Rb+s, 'r'), title('R_b=2h'),
subplot(224), Rb=4*h; polar(th,Rb+s, 'r'), title('R_b=4h'),
